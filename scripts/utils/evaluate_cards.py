...
Usage:
    python -m scripts.utils.evaluate_cards [--set-code sos] [--output path/to/output.json]
    
Examples:
    # Evaluate SOS cards (default)
    python -m scripts.utils.evaluate_cards
    
    # Fetch fresh data from Scryfall and evaluate
    python -m scripts.utils.evaluate_cards --fetch-fresh
    
    # Evaluate with custom output
    python -m scripts.utils.evaluate_cards --output evaluated_sos_cards.json
"""
